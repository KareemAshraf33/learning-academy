              ...
              <div class="col-sm-6 col-lg-4">
                    <div class="single_special_cource">
                        ...
                        <div class="special_cource_text">
                            <a href="{{route('front.courseCategory',$course->category->id)}}" class="btn_4">{{$course->category->name}}</a>
                            <h4>${{$course->price}}</h4>
                            <a href="{{route('front.show',[$course->category->id,$course->id])}}"><h3>{{$course->name}}</h3></a>
                            <p>{{$course->desc}}</p>
                            <div class="author_info">
                                <div class="author_img">
                                    <img src="{{asset('uploads/trainers/'.$course->trainer->img) }}" alt="" width="50px" height="50px">
